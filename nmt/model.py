...
class Model(BaseModel):
  ...
  def _build_bidirectional_rnn(self, inputs, sequence_length,
    ...
    if 'cudnn' in hparams.unit_type:
      ...
      layer_out, bi_state = model_helper.create_cudnn_rnn(hparams.unit_type, hparams.num_units, num_bi_layers, num_bi_residual_layers,
                                                          hparams.forget_bias, hparams.dropout, self.mode, hparams.num_gpus, base_gpu=base_gpu, sequence_length=sequence_length, bidirectional=True, inputs=inputs)
